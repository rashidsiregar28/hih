...
const cersex = () => new Promise((resolve, reject) => {
    console.log(`Searching random cersex....`)
 ...
 * @returns {Object}
 */
const bokep = () => new Promise((resolve, reject) => {
    console.log('Searching.....')
    fetchJson(`https://pastebin.com/raw/k82VJzeP`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
/**
 * Get Xnxx video from URL.
 * @param {String} url 
 * @returns {Object}
 */
const xnxdl = (url) => new Promise((resolve, reject) => {
    console.log(`Get Xnxx media from ${url}`)
    fetchJson(`https://mhankbarbar.tech/api/xnxx?url=${url}&apiKey=${config.barbar}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
/**
 * Search Random indo hot.
 * @returns {Object}
 */
const indohot = () => new Promise((resolve, reject) => {
    console.log('Searching.....')
    fetchJson(`https://arugaz.herokuapp.com/api/indohot`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
